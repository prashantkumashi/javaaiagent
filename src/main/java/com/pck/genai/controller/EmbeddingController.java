...
public class EmbeddingController {
    ...
    public ResponseEntity<List<String>> matchServices(@RequestBody ChatRequest request) throws Exception {
        ...
        for (Map<String, Object> service : DATA) {
            String serviceDescription = service.get("type") + " in " + service.get("cloud") + " " + service.get("service") + " " + service.get("summary") + " " + service.get("short_description");
            ...
            if (similarity > 0.8) {
                matchedIds.add(String.valueOf((Integer) service.get("id")));
            }
        }
    ...
    private double[] getEmbedding(String text) throws Exception {
        ...
        System.out.println("Embedding controller ..... "+headers);
